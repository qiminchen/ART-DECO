...
def get_vox_from_binvox_512(objname):
    ...
    voxel_model_512 = read_as_3d_array(voxel_model_file, fix_coords=True).data.astype(np.uint8)
...
def get_simple_coarse_voxel(voxels):
    all_vertices_len = 0
    all_triangles_len = 0
    ...
    return all_vertices[:all_vertices_len], all_triangles[:all_triangles_len]
